...
public class AddEntityToExportDialogPanel extends JPanel implements VerifiedInputEditor {
    private static final long serialVersionUID = 7753039704182835818L;
    ...
    private void initUi() {
        ...
        int widest = LuceneUiUtils.getWidestEntityStringRendering(editorKit, allEntitiesList, getFontMetrics(getFont()));
